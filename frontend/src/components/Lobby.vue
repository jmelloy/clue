        ...
        <div class="lobby-grid">
          ...
          <section class="card card-create">
            <div class="card-inner">
              ...
              <p class="card-desc">{{ gameType === 'holdem' ? 'Take your seat at the table and test your nerve.' : 'Gather your suspects and uncover the truth. As host, you\'ll set the stage for murder.' }}</p>
              <div class="form-group">
                <div class="input-wrapper">
          ...
          <section class="card card-join">
            <div class="card-inner">
              ...
              <p class="card-desc">{{ gameType === 'holdem' ? 'Got a table number? Enter it to take your seat.' : 'You\'ve received an invitation to Tudor Mansion. Enter the case number to join.' }}</p>
              <div class="form-group">
